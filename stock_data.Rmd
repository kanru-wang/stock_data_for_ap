...
```{r}
plot(sum_market_cap ~ DATE, INDEX, type = "l")
```
...
```{r}
index_divisor = INDEX$sum_market_cap[1] / SP500TR$`Adj Close`[1]
INDEX_aligned_with_SP500TR = INDEX %>% mutate(index = sum_market_cap / index_divisor)
```
