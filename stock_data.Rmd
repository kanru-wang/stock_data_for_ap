...
Index|Start Date |Start Date Value|End Date|End Date Value|Cumulative Total Return|Cumulative Total Return p.a.|Annualised Volatility of Daily Returns
---------|-----------|-------|-----------|--------|-------|--------|-----------
...
# Chart the 30d average annualised standard deviation of daily returns for all US stocks in the top quintile of market capitalisation (at each point in time). Notice that the context is still 
